<section class="relative h-full flex justify-center py-28 bg-cream">
    <div class="flex flex-col w-full py-28 bg-teal-700">
        <div class="flex flex-col">
            <div class="pb-14 text-3xl text-cream font-dela uppercase text-center">fluffy cafe menu</div>
            <div class="flex flex-row ml-32">
                <a href="" class="flex p-3 w-fit pr-5 px-5 bg-teal-950 rounded-xl mr-25 mb-5">
                    <p class="text-seashell font-medium">Add Menu</p>
                </a>
            </div>
            <div class="flex flex-row">
                <table class="w-full mx-32 bg-teal-800 rounded-2xl">
                        <tr class="bg-teal-900">
                            ...
                            <th class="uppercase text-cream font-dela text-lg">jenis</th>
