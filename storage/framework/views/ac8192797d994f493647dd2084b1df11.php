...
<div class="flex justify-center items-center h-screen ">
    <div class="flex flex-col justify-center items-center h-fit py-24 w-5/12 bg-slate-100 rounded-3xl drop-shadow-lg">
        ...
        <div class="flex flex-col items-start">
            <form action="<?php echo e(route('register.action')); ?>" method="post" class="w-full flex flex-col items-start">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\framework-posttest-framework\resources\views/auth/regist.blade.php ENDPATH**/ ?>