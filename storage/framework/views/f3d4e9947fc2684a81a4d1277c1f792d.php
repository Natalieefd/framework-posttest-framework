...
<div class="flex justify-center items-center h-screen bg-cream">
    <div class="flex flex-col justify-center items-center h-fit py-16 w-5/12 bg-teal-800 rounded-3xl drop-shadow-lg">
        ...
        <div class="flex flex-col items-start">
            <form action="<?php echo e(route('admin.create')); ?>" method="post" class="w-full flex flex-col items-start">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\framework-posttest-framework\resources\views/admin/crud/createStaff.blade.php ENDPATH**/ ?>