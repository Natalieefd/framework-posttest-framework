    ...
    <div class="flex flex-col w-full py-28 bg-teal-700">
        <div class="flex flex-col">
            ...
            <div class="flex flex-col ml-32">
                <a href="{{ route('admin.store') }}" class="flex p-3 w-fit px-5 bg-teal-950 rounded-xl mr-25 mb-5">
                            ...
                            <td>
                                ...
                                <tr>
                                    ...
                                    <th class="flex gap-2 justify-center text-cream">
                                        <a href="{{ route('admin.edit', $st->id) }}" class="py-2">
                                        ...
                                        <form action="{{ route('admin.delete', $st->id) }}" method="POST" class="py-2">
                                            @csrf
